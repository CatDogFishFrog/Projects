...
namespace Tetris
{
    class Program
    {
        ...
        public static int[,] droppedtetrominoeLocationGrid = new int[23, 10]; public static Stopwatch timer = new Stopwatch();
        ...
        static void Main()
        {
            ...
            sp.SoundLocation = Environment.CurrentDirectory + "\\01_-_Tetris_Tengen_-_NES_-_Introduction.wav";  //sp.PlayLooping(); 
            drawBorder();
            ...
            Update();
            sp.Stop();
            //sp.SoundLocation = Environment.CurrentDirectory + "\\08_-_Tetris_Tengen_-_NES_-_Game_Over.wav"; sp.Play();
            Console.SetCursorPosition(0, 0);
            Console.WriteLine("Game Over \n Replay? (Y/N)");
            string input = Console.ReadLine();
            if (input == "y" || input == "Y")
            {
                int[,] grid = new int[23, 10]; droppedtetrominoeLocationGrid = new int[23, 10]; timer = new Stopwatch();
        ...
        private static void fillGrid()
        {
            for (int i = 0; i < 23; ++i)
            {
                Console.SetCursorPosition(1, i); for (int j = 0; j < 10; j++)
                {
                    Console.Write(sqr);
                }
                Console.WriteLine();
        ...
        private static void Update()
        {
            ...
            {
                dropTime = (int)dropTimer.ElapsedMilliseconds; if (dropTime > dropRate)
                {
                ...
                {
                    tet = nexttet;
                    nexttet = new Tetrominoe(); tet.Spawn();
                    isDropped = false;
                }
                int j;
                for (j = 0; j < 10; j++)
        ...
        private static void ClearBlock()
        {
            ...
            for (int i = 0; i < 23; i++)
            {
                ...
                if (j == 10)
                {
                    ...
                    int[,] newdroppedtetrominoeLocationGrid = new int[23, 10]; for (int k = 1; k < i; k++)
                    {
                        for (int l = 0; l < 10; l++)
                        {
                    ...
                    for (int k = 0; k < 23; k++)
                        for (int l = 0; l < 10; l++)
                            if (newdroppedtetrominoeLocationGrid[k, l] == 1) droppedtetrominoeLocationGrid[k, l] = 1;
                    Draw();
                }
            }
            if (combo == 1)
        ...
        private static void Input()
        {
            ...
            {
                key = Console.ReadKey(); isKeyPressed = true;
            }
            else
                isKeyPressed = false;
        ...
        public static void Draw()
        {
            for (int i = 0; i < 23; ++i)
            {
                for (int j = 0; j < 10; j++)
                {
                    ...
                    {
                        Console.SetCursorPosition(1 + 2 * j, i); Console.Write(sqr);
                    }
                    else
                    {
                        Console.Write(" ");
        ...
        public static void drawBorder()
        {
            ...
            {
                Console.SetCursorPosition(0, lengthCount); Console.Write("*");
                Console.SetCursorPosition(21, lengthCount); Console.Write("*");
            }
    ...
    public class Tetrominoe
    {
        ...
        public Tetrominoe()
        {
            ...
            shape = tetrominoes[rnd.Next(0, 7)]; for (int i = 23; i < 33; ++i)
            {
                for (int j = 3; j < 10; j++)
                {
            ...
            for (int i = 0; i < shape.GetLength(0); i++)
            {
                for (int j = 0; j < shape.GetLength(1); j++)
                {
                    if (shape[i, j] == 1)
                    {
                        Console.SetCursorPosition(((10 - shape.GetLength(1)) / 2 + j) * 2 + 20, i + 5); Console.Write(Program.sqr);
                    }
                }
            }
        }
        ...
        public void Drop()
        {
            if (isSomethingBelow())
            {
                ...
                // SoundPlayer sp = new SoundPlayer();  
                // sp.SoundLocation = Environment.CurrentDirectory + "\\wood_hit_plastic_1.wav";  // sp.Play();  
            }
            else
            {
        ...
        public void Rotate()
        {
            List<int[]> templocation = new List<int[]>(); for (int i = 0; i < shape.GetLength(0); i++)
            {
                for (int j = 0; j < shape.GetLength(1); j++)
                {
                    if (shape[i, j] == 1)
        ...
        {
            List<int> ycoords = new List<int>(); for (int i = 0; i < 4; i++)
            {
                ycoords.Add(location[i][0]); if (location[i][0] >= 23)
                    return true;
                if (location[i][0] < 0)
                    return null;
                if (location[i][1] < 0)
        ...
        {
            List<int> xcoords = new List<int>(); for (int i = 0; i < 4; i++)
            {
                xcoords.Add(location[i][1]); if (location[i][1] < 0)
                {
                    return true;
                }
                if (location[i][1] > 9)
        ...
        public bool? isOverlayRight(List<int[]> location)
        {
            List<int> xcoords = new List<int>(); for (int i = 0; i < 4; i++)
            {
                xcoords.Add(location[i][1]); if (location[i][1] > 9)
                {
                    return true;
                }
                if (location[i][1] < 0)
